...
module.exports = async ({ getNamedAccounts }) => {
  ...
  const implFactoryAddress  = await upgrades.erc1967.getImplementationAddress(proxyAddress);

  console.log("代理地址:", proxyAddress);
  console.log("逻辑地址:", implFactoryAddress);
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(
      {
        NFTAuctionFactory: implFactoryAddress,
